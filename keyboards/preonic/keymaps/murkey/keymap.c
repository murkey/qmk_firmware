 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Lower |Raise | Alt  | GUI  |Space | Del  | Bksp |Space | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {LOWER,   RAISE,   KC_LALT, KC_LGUI, KC_SPC,  KC_DEL,  KC_BSPC, KC_SPC,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
 ...
 */
[_LOWER] = {
  {KC_ESC , _______, _______, _______, _______, _______, _______, _______, _______, KC_LPRN, KC_RPRN, KC_PLUS},
  {KC_CAPS, _______, _______, _______, _______, _______, _______, _______, _______, KC_LCBR, KC_RCBR, KC_EQL },
